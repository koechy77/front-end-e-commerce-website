    ...
    <main className="min-h-screen mx-7 my-17">
      ...
      <div className="mx-auto max-w-6xl font-poppins">
        ...
        <div className="grid gap-8 rounded-3xl bg-white p-4 shadow-xl md:grid-cols-2 md:p-8">
          ...
          <div className="flex flex-col justify-center gap-5">
            <div>
              ...
              <h2 className="font-supermercado text-3xl text-gray-900 md:text-4xl">
                {product.name}
              </h2>
            </div>
            ...
            <div className="flex items-center gap-3">
              <span
                className={`rounded-full px-3 py-1 text-sm font-semibold ${product.stock > 0 ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
              >
                {product.stock > 0
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {benefits.map(({ icon, text }) => (
                <div
                  key={text}
                  className="flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 p-3 text-sm text-gray-700"
                >
        ...
        <section className="mt-12 rounded-3xl bg-gray-50 p-6 shadow-inner">
          <h3 className="mb-4 font-supermercado text-2xl text-gray-900">
            Why customers love this
          </h3>
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl bg-white p-5 shadow-sm">
              <h4 className="mb-2 font-supermercado text-xl text-gray-900">
                Performance
              </h4>
              <p className="text-gray-600">
                Built for speed, comfort, and reliability wherever you use it.
              </p>
            </div>
            <div className="rounded-2xl bg-white p-5 shadow-sm">
              <h4 className="mb-2 font-supermercado text-xl text-gray-900">
              ...
              <p className="text-gray-600">
                Carefully selected materials and dependable features that last.
              </p>
            </div>
            <div className="rounded-2xl bg-white p-5 shadow-sm">
              <h4 className="mb-2 font-supermercado text-xl text-gray-900">
              ...
              <p className="text-gray-600">
                Premium features at a price that makes everyday buying easier.
              </p>
            </div>
          </div>
        </section>
        ...
        {relatedProducts.length > 0 && (
          <section className="mt-12">
            <h3 className="mb-6 font-supermercado text-2xl text-gray-900">
              You may also like
            </h3>
